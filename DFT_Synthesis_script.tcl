...
set_db init_hdl_search_path /home/student/22BEC1413/WORK
read_libs slow.lib
read_hdl Low_area_ALU.v
elaborate
read_sdc alu_contraints.g
...
set_db design:Low_area_ALU .dft_min_number_of_scan_chains 1
...
write_hdl > Low_area_ALU_netlist_dft.v
write_sdf -timescale ns -nonegchecks -recrem split -edges check_edge -setuphold split > delays.sdf
write_sdc > Low_area_ALU_constraints_dft.sdc
write_scandef > Low_area_ALU_scanDEF.scandef 
